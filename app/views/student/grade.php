...
try {
    ...
    // Récupération de l'ID de l'étudiant (on pourrait le récupérer de la session)
    $student_id = 15; // Par défaut l'étudiant avec ID 1
    ...
    $stmt_subjects = $pdo->query("SELECT * FROM subjects");
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            foreach ($grades_by_subject as $subject_id => $data) {
                if (!empty($data['grades'])) {
                    // Calcul de la moyenne par matière (code similaire à celui dans la boucle plus bas)
                    $subject_sum = 0;
                    $entry_count = 0;
            ...
            <?php if ($subject_count > 0): ?>
                <div class="global-stats">
                    <h4 class="mb-0">Moyenne générale pour le moment</h4>
